...
CREATE TABLE IF NOT EXISTS "public"."properties" (
    ...
    CONSTRAINT "properties_property_type_check" CHECK ((("property_type")::"text" = ANY ((ARRAY['casa'::character varying, 'terreno'::character varying])::"text"[])))
);
...
COMMENT ON COLUMN "public"."properties"."property_type" IS 'Tipo de inmueble: casa o terreno';
